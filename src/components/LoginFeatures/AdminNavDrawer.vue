<template>
        <v-navigation-drawer v-model="drawer" color="blue-lighten-4" temporary>
            ...
            <v-list density="comfortable" rounded="2" nav v-model="selectedSettings">
              ...
              <router-link class="router-link-item" :to="{ name : 'Adminhome'}">
              ...
              <v-hover>
              <template v-slot:default="{ isHovering, props }">
              <router-link class="router-link-item" :to="{name : 'Database'}">
              <v-list-item 
              v-bind="props"
            ...
            <v-hover>
              <template v-slot:default="{ isHovering, props }">
              <router-link class="router-link-item" :to="{ name : 'Inventory'}">
                <v-list-item 
                v-bind="props"
  ...
  data() {
    return {
      drawer: null,
      selectedSettings: "",
      firstname: "Admin", // fetch data from firebase and populate form
      lastname: "Admin",
      password: "",
      confirmPassword: "",
      show1: false,
